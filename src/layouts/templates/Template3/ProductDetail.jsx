...
const ProductDetail = () => {
    ...
    return (
      <div className="min-h-screen bg-[#eeeeee] flex items-center justify-center">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate(-1)}
            className="px-8 py-3 bg-[#d72323] text-white rounded-xl hover:bg-[#303841] transition-all"
          >
            Go Back
          </button>
        </div>
  ...
  const RatingStars = ({ rating }) => (
    <div className="flex items-center gap-1">
      ...
      <span className="text-sm text-[#3a4750] ml-2">
  ...
  return (
    <div className="min-h-screen bg-[#eeeeee] py-8 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Back Button */}
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-[#303841] hover:text-[#d72323] font-semibold mb-8 transition-colors group"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl">
              ...
              <div className="grid grid-cols-3 gap-3 mb-6">
                <div className=" rounded-lg p-3 text-center">
                  <Package className="w-6 h-6 mx-auto mb-2 text-[#d72323]" />
                  <p className="text-xs font-semibold text-[#303841]">Free Shipping</p>
                </div>
                <div className=" rounded-lg p-3 text-center">
                  <Shield className="w-6 h-6 mx-auto mb-2 text-[#d72323]" />
                  <p className="text-xs font-semibold text-[#303841]">Secure Payment</p>
                </div>
                <div className=" rounded-lg p-3 text-center">
                  <Zap className="w-6 h-6 mx-auto mb-2 text-[#d72323]" />
                  <p className="text-xs font-semibold text-[#303841]">Fast Delivery</p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            {/* Header */}
            <div>
              <span className="inline-block bg-[#d72323] text-white px-4 py-1.5 rounded-full text-sm font-bold mb-4">
                {product.category}
              </span>
              <h1 className="text-2xl sm:text-3xl md:text-3xl font-semibold text-[#303841] mb-4">
                {product.name}
              </h1>
            ...
            {product.highlights && product.highlights.length > 0 && (
              <div >
                <h3 className="text-xl font-semibold text-[#303841] mb-4">
                  Key Highlights
                </h3>
                <ul className="space-y-3">
                  {product.highlights.map((highlight, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      ...
                      <span className="text-[#3a4750] leading-relaxed">{highlight}</span>
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div >
          ...
          <div className="flex justify-center items-center border-b-2  border-gray-200 overflow-x-auto">
            <button
              ...
              className={`px-6 py-4 font-bold transition-all whitespace-nowrap ${
                activeTab === "benefits"
                  ? "text-[#d72323] border-2 rounded-full  border-[#d72323]"
                  : "text-[#3a4750] hover:text-[#303841]"
              }`}
            >
              Benefits
            </button>
          ...
          <div className="p-6 sm:p-8">
            {activeTab === "benefits" && (
              <div>
                <h3 className="text-xl font-semibold text-[#303841] mb-6">
                  Product Benefits
                </h3>
