      ...
      <div className="bg-gradient-to-r from-[#004445] to-[#2c786c] text-white mb-12">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center py-12">
          ...
          <div className="p-6 md:p-12">
            <span className="inline-block bg-[#f8b400] text-[#004445] px-4 py-1 rounded-full text-sm font-bold mb-4">
              PREMIUM WELLNESS
            </span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-[#f8b400] text-[#004445] px-8 py-3 rounded-lg font-bold hover:bg-[#ffa500] transition-all flex items-center justify-center gap-2 shadow-lg">
                Explore Products <ArrowRight className="w-5 h-5" />
              </button>
              <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-bold hover:bg-white hover:text-[#004445] transition-all">
                View Best Sellers
              </button>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            ...
            formulas for every health goal.
          </p>
        </div>
        ...
        <div className="mb-12 max-w-2xl mx-auto">
          <div className="relative">
            <input
              type="text"
              placeholder="Search by name or category (e.g., Weight Loss, Keto, Energy)..."
              value={searchQuery}
...
export default Template1Products;
