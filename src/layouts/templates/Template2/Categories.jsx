...
const Template2Categories = () => {
  ...
  const [pageContent, setPageContent] = useState({
    hero_title: "Shop by Category",
    hero_subtitle: "Explore our wide range of product categories",
    categories_title: "Browse Our Categories",
    categories_description: "Find exactly what you're looking for",
    cta_title: "Ready to Start Shopping?",
    cta_description: "Join thousands of satisfied customers",
    cta_button_text: "Shop Now",
    cta_support_text: "Contact Support"
  });
  ...
  // Fetch page content and categories from backend
  useEffect(() => {
