...
const Template2FAQ = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50">
      ...
      {/* CTA Section - Exact Same as Categories/About */}
      <div className="bg-[radial-gradient(circle_at_center,_#3b82f6,_#1e3a8a)] py-20 m-12 rounded-3xl shadow-2xl overflow-hidden">
        <div className="container mx-auto px-4 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            >
              {pageContent.cta_button_text} <MessageCircle className="w-6 h-6" />
            </a>
            <a
              href={pageContent.cta_secondary_button_link}
              className="border-2 border-white text-white px-10 py-5 rounded-full hover:bg-white hover:text-black transition font-medium text-lg"
            >
