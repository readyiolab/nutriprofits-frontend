            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-7 text-left">
                ...
                <p className="text-base text-emerald-100/80 font-light leading-relaxed mb-8 max-w-xl">
                  Discover the latest breakthroughs in health science, nutrition advice, and natural supplement strategies curated by our experts from {storeName}.
                </p>
                        ...
                        <div className="flex items-center justify-between pt-8 border-t border-slate-100">
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 font-bold font-t2-heading">
                              {filteredBlogs[0].author ? filteredBlogs[0].author.charAt(0) : "A"}
                            </div>
                            <div>
                              <p className="text-sm font-bold text-slate-900">{filteredBlogs[0].author || "Author"}</p>
                    ...
                    >
                      <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100 h-full flex flex-col relative">
                        ...
                        <div className="p-8 flex flex-col flex-grow">
                          ...
                          <div className="flex items-center justify-between pt-6 border-t border-slate-55 border-slate-50">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{blog.author || "Author"}</span>
                            </div>
