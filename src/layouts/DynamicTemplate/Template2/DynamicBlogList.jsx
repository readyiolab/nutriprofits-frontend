      ...
      <section className="relative bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-800 py-16 md:py-24 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-2xl mx-auto mb-8">
            Explore insightful articles, guides, and stories from {storeName}
          </p>
          ...
          <div className="max-w-md mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-full bg-white/95 backdrop-blur-sm text-gray-800 placeholder-gray-400 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400 shadow-lg"
            />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        {filteredBlogs.length === 0 ? (
          <div className="text-center py-20">
            <BookOpen className="w-16 h-16 text-blue-300/50 mx-auto mb-4" />
            ...
            {filteredBlogs.length > 0 && !searchTerm && (
              <article className="mb-12">
                <Link
                  ...
                  className="group block bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100/80"
                >
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-50">
                        ...
                        <span className="flex items-center gap-1 text-blue-600 text-xs font-medium group-hover:gap-2 transition-all ml-auto">
