    ...
    <DomainVerificationProvider>
      <div className="h-screen flex flex-col overflow-hidden" style={{ backgroundColor: "#F8FAFC" }}>
        ...
        <div className="flex flex-1 overflow-hidden">
          {/* Sidebar */}
          <aside
            className={`z-40 flex-shrink-0 transition-all duration-300 ease-in-out lg:relative fixed inset-y-0 left-0 ${
                  ...
                  <TooltipProvider delayDuration={0}>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        className="hidden lg:flex hover:bg-white/10 text-white transition-all"
                      >
                        {sidebarExpanded ? (
